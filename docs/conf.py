...
extensions = [
    ...
    'autoapi.extension',        # auto-generates API reference pages
]

# autoapi: point to the package source
autoapi_dirs = ['../oilftir']
autoapi_type = 'python'
autoapi_options = [
    'members',
    'undoc-members',
...
# ---------------------------------------------------------------------------
# HTML output — Furo theme (clean, modern, dark-mode support)
# ---------------------------------------------------------------------------
html_theme = 'furo'
...
html_theme_options = {
    ...
    'footer_icons': [
        {
            'name': 'GitHub',
            'url':  'https://github.com/NahueMendez/oilftir',
            'html': '''
